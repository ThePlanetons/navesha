...
export default function Collections() {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const response = await fetch("/api/landing/featured-collections/collection-categories");
  ...
  const fetchCollections = async () => {
    try {
      ...
      const response = await fetch(
        "/api/landing/featured-collections"
      );
      ...
      <div className="w-full">
        ...
        >
          {collections.map((collection, i) => {
            ...
            const galleryImages =
              collection.collection_images?.filter(
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    onClick={() =>
                      router.push(`/featured-collections/${collection.slug}`)
                    }
